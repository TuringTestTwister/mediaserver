{ ... }:
{
  ...
  ## Generate with:
  ##   mkpasswd -m sha-512
  hashedPassword = "$6$P7FoUX4NTAOXpymT$LjjgZ08lqu5w9jy7Tq3aZ0TpKU032A5ZSoztlZxdnx/4Q51tz/6zVPv49LMBpVcXxaB4wBJ3MCkZNttuDW4iI.";
  wifiSSID = "rubber-duck";
  wifiPassword = "zhou1zhong888";
  snapcastLatency = "60";
  # snapcastServerHost = "::1";
  snapcastServerHost = "partymusic.lan";
  controller = true;
